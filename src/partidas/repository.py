...
from src.partidas.schema import ElencoResponse, Jogador, Liga, PartidaProxima, PartidaResultado, TabelaTime, TimeInfo
...
def get_ultimos_resultados(league_id: str, limit: int = 10) -> List[PartidaResultado]:
    ...
    if not events:
        try:
            ...
            events = data_v1.get("results") or data_v1.get("events") or []
        except Exception:
            events = []
